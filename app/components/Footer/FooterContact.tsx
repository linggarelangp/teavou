        ...
        <div className="w-1/2 lg:w-1/4 text-gray-300 flex flex-col mb-4 lg:mb-0">
            ...
            <div className="space-y-2 font-extralight mb-2">
                <p className="font-extralight">
                    Address: Jl. Ring Road Utara, Ngringin, Condongcatur, Kec. Depok, Kabupaten Sleman, Daerah Istimewa
                    Yogyakarta 55281
                </p>
                <p className="font-extralight">Email: teavou.priority@teavou.com</p>
